...
CFLAGS = -g -Wall -D$(ALT_DEVICE_FAMILY) -I$(HWLIBS_ROOT)/include/$(ALT_DEVICE_FAMILY) -I$(HWLIBS_ROOT)/include/ -Wno-unknown-pragmas -Wno-unused-variable -Wno-unused-function
LDFLAGS = -g -Wall -lm
