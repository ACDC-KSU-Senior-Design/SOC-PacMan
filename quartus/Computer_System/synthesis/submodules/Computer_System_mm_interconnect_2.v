...
module Computer_System_mm_interconnect_2 (
		...
		input  wire        PacMan_Score_PIO_reset_reset_bridge_in_reset_reset,                       //                       PacMan_Score_PIO_reset_reset_bridge_in_reset.reset
		...
		output wire [1:0]  PacMan_Score_PIO_s1_address,                                              //                                                PacMan_Score_PIO_s1.address
		output wire        PacMan_Score_PIO_s1_write,                                                //                                                                   .write
		input  wire [31:0] PacMan_Score_PIO_s1_readdata,                                             //                                                                   .readdata
		output wire [31:0] PacMan_Score_PIO_s1_writedata,                                            //                                                                   .writedata
		output wire        PacMan_Score_PIO_s1_chipselect,                                           //                                                                   .chipselect
	...
	wire   [31:0] pacman_score_pio_s1_agent_m0_readdata;                                       // PacMan_Score_PIO_s1_translator:uav_readdata -> PacMan_Score_PIO_s1_agent:m0_readdata
	wire          pacman_score_pio_s1_agent_m0_waitrequest;                                    // PacMan_Score_PIO_s1_translator:uav_waitrequest -> PacMan_Score_PIO_s1_agent:m0_waitrequest
	wire          pacman_score_pio_s1_agent_m0_debugaccess;                                    // PacMan_Score_PIO_s1_agent:m0_debugaccess -> PacMan_Score_PIO_s1_translator:uav_debugaccess
	wire   [20:0] pacman_score_pio_s1_agent_m0_address;                                        // PacMan_Score_PIO_s1_agent:m0_address -> PacMan_Score_PIO_s1_translator:uav_address
	wire    [3:0] pacman_score_pio_s1_agent_m0_byteenable;                                     // PacMan_Score_PIO_s1_agent:m0_byteenable -> PacMan_Score_PIO_s1_translator:uav_byteenable
	wire          pacman_score_pio_s1_agent_m0_read;                                           // PacMan_Score_PIO_s1_agent:m0_read -> PacMan_Score_PIO_s1_translator:uav_read
	wire          pacman_score_pio_s1_agent_m0_readdatavalid;                                  // PacMan_Score_PIO_s1_translator:uav_readdatavalid -> PacMan_Score_PIO_s1_agent:m0_readdatavalid
	wire          pacman_score_pio_s1_agent_m0_lock;                                           // PacMan_Score_PIO_s1_agent:m0_lock -> PacMan_Score_PIO_s1_translator:uav_lock
	wire   [31:0] pacman_score_pio_s1_agent_m0_writedata;                                      // PacMan_Score_PIO_s1_agent:m0_writedata -> PacMan_Score_PIO_s1_translator:uav_writedata
	wire          pacman_score_pio_s1_agent_m0_write;                                          // PacMan_Score_PIO_s1_agent:m0_write -> PacMan_Score_PIO_s1_translator:uav_write
	wire    [2:0] pacman_score_pio_s1_agent_m0_burstcount;                                     // PacMan_Score_PIO_s1_agent:m0_burstcount -> PacMan_Score_PIO_s1_translator:uav_burstcount
	wire          pacman_score_pio_s1_agent_rf_source_valid;                                   // PacMan_Score_PIO_s1_agent:rf_source_valid -> PacMan_Score_PIO_s1_agent_rsp_fifo:in_valid
	wire  [118:0] pacman_score_pio_s1_agent_rf_source_data;                                    // PacMan_Score_PIO_s1_agent:rf_source_data -> PacMan_Score_PIO_s1_agent_rsp_fifo:in_data
	wire          pacman_score_pio_s1_agent_rf_source_ready;                                   // PacMan_Score_PIO_s1_agent_rsp_fifo:in_ready -> PacMan_Score_PIO_s1_agent:rf_source_ready
	wire          pacman_score_pio_s1_agent_rf_source_startofpacket;                           // PacMan_Score_PIO_s1_agent:rf_source_startofpacket -> PacMan_Score_PIO_s1_agent_rsp_fifo:in_startofpacket
	wire          pacman_score_pio_s1_agent_rf_source_endofpacket;                             // PacMan_Score_PIO_s1_agent:rf_source_endofpacket -> PacMan_Score_PIO_s1_agent_rsp_fifo:in_endofpacket
	wire          pacman_score_pio_s1_agent_rsp_fifo_out_valid;                                // PacMan_Score_PIO_s1_agent_rsp_fifo:out_valid -> PacMan_Score_PIO_s1_agent:rf_sink_valid
	wire  [118:0] pacman_score_pio_s1_agent_rsp_fifo_out_data;                                 // PacMan_Score_PIO_s1_agent_rsp_fifo:out_data -> PacMan_Score_PIO_s1_agent:rf_sink_data
	wire          pacman_score_pio_s1_agent_rsp_fifo_out_ready;                                // PacMan_Score_PIO_s1_agent:rf_sink_ready -> PacMan_Score_PIO_s1_agent_rsp_fifo:out_ready
	wire          pacman_score_pio_s1_agent_rsp_fifo_out_startofpacket;                        // PacMan_Score_PIO_s1_agent_rsp_fifo:out_startofpacket -> PacMan_Score_PIO_s1_agent:rf_sink_startofpacket
	wire          pacman_score_pio_s1_agent_rsp_fifo_out_endofpacket;                          // PacMan_Score_PIO_s1_agent_rsp_fifo:out_endofpacket -> PacMan_Score_PIO_s1_agent:rf_sink_endofpacket
	wire          pacman_score_pio_s1_agent_rdata_fifo_src_valid;                              // PacMan_Score_PIO_s1_agent:rdata_fifo_src_valid -> PacMan_Score_PIO_s1_agent_rdata_fifo:in_valid
	wire   [33:0] pacman_score_pio_s1_agent_rdata_fifo_src_data;                               // PacMan_Score_PIO_s1_agent:rdata_fifo_src_data -> PacMan_Score_PIO_s1_agent_rdata_fifo:in_data
	wire          pacman_score_pio_s1_agent_rdata_fifo_src_ready;                              // PacMan_Score_PIO_s1_agent_rdata_fifo:in_ready -> PacMan_Score_PIO_s1_agent:rdata_fifo_src_ready
	...
	wire          pacman_score_pio_s1_agent_rp_valid;                                          // PacMan_Score_PIO_s1_agent:rp_valid -> router_013:sink_valid
	wire  [117:0] pacman_score_pio_s1_agent_rp_data;                                           // PacMan_Score_PIO_s1_agent:rp_data -> router_013:sink_data
	wire          pacman_score_pio_s1_agent_rp_ready;                                          // router_013:sink_ready -> PacMan_Score_PIO_s1_agent:rp_ready
	wire          pacman_score_pio_s1_agent_rp_startofpacket;                                  // PacMan_Score_PIO_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          pacman_score_pio_s1_agent_rp_endofpacket;                                    // PacMan_Score_PIO_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire  [117:0] button_pio_s1_agent_rp_data;                                                 // Button_PIO_s1_agent:rp_data -> router_014:sink_data
	...
	wire   [13:0] cmd_mux_src_channel;                                                         // cmd_mux:src_channel -> AV_Config_avalon_av_config_slave_burst_adapter:sink0_channel
	...
	wire   [13:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> VGA_Subsystem_char_buffer_control_slave_burst_adapter:sink0_channel
	...
	wire   [13:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> SysID_control_slave_burst_adapter:sink0_channel
	...
	wire   [13:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> HEX3_HEX0_s1_burst_adapter:sink0_channel
	...
	wire   [13:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> Slider_Switches_s1_burst_adapter:sink0_channel
	...
	wire   [13:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> Pushbuttons_s1_burst_adapter:sink0_channel
	...
	wire   [13:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> Audio_ctrl_s1_burst_adapter:sink0_channel
	...
	wire   [13:0] audio_ctrl_s1_burst_adapter_source0_channel;                                 // Audio_ctrl_s1_burst_adapter:source0_channel -> Audio_ctrl_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_008_src_channel;                                                     // cmd_mux_008:src_channel -> Audio_space_s1_burst_adapter:sink0_channel
	...
	wire   [13:0] audio_space_s1_burst_adapter_source0_channel;                                // Audio_space_s1_burst_adapter:source0_channel -> Audio_space_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_009_src_channel;                                                     // cmd_mux_009:src_channel -> Audio_DACL_Dat_s1_burst_adapter:sink0_channel
	...
	wire   [13:0] audio_dacl_dat_s1_burst_adapter_source0_channel;                             // Audio_DACL_Dat_s1_burst_adapter:source0_channel -> Audio_DACL_Dat_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_010_src_channel;                                                     // cmd_mux_010:src_channel -> Audio_ADCL_Dat_s1_burst_adapter:sink0_channel
	...
	wire   [13:0] audio_adcl_dat_s1_burst_adapter_source0_channel;                             // Audio_ADCL_Dat_s1_burst_adapter:source0_channel -> Audio_ADCL_Dat_s1_agent:cp_channel
	...
	wire          cmd_mux_011_src_valid;                                                       // cmd_mux_011:src_valid -> PacMan_Score_PIO_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_011_src_data;                                                        // cmd_mux_011:src_data -> PacMan_Score_PIO_s1_burst_adapter:sink0_data
	wire          cmd_mux_011_src_ready;                                                       // PacMan_Score_PIO_s1_burst_adapter:sink0_ready -> cmd_mux_011:src_ready
	wire   [13:0] cmd_mux_011_src_channel;                                                     // cmd_mux_011:src_channel -> PacMan_Score_PIO_s1_burst_adapter:sink0_channel
	wire          cmd_mux_011_src_startofpacket;                                               // cmd_mux_011:src_startofpacket -> PacMan_Score_PIO_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                                 // cmd_mux_011:src_endofpacket -> PacMan_Score_PIO_s1_burst_adapter:sink0_endofpacket
	wire          pacman_score_pio_s1_burst_adapter_source0_valid;                             // PacMan_Score_PIO_s1_burst_adapter:source0_valid -> PacMan_Score_PIO_s1_agent:cp_valid
	wire  [117:0] pacman_score_pio_s1_burst_adapter_source0_data;                              // PacMan_Score_PIO_s1_burst_adapter:source0_data -> PacMan_Score_PIO_s1_agent:cp_data
	wire          pacman_score_pio_s1_burst_adapter_source0_ready;                             // PacMan_Score_PIO_s1_agent:cp_ready -> PacMan_Score_PIO_s1_burst_adapter:source0_ready
	wire   [13:0] pacman_score_pio_s1_burst_adapter_source0_channel;                           // PacMan_Score_PIO_s1_burst_adapter:source0_channel -> PacMan_Score_PIO_s1_agent:cp_channel
	wire          pacman_score_pio_s1_burst_adapter_source0_startofpacket;                     // PacMan_Score_PIO_s1_burst_adapter:source0_startofpacket -> PacMan_Score_PIO_s1_agent:cp_startofpacket
	wire          pacman_score_pio_s1_burst_adapter_source0_endofpacket;                       // PacMan_Score_PIO_s1_burst_adapter:source0_endofpacket -> PacMan_Score_PIO_s1_agent:cp_endofpacket
	wire          cmd_mux_012_src_valid;                                                       // cmd_mux_012:src_valid -> Button_PIO_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_012_src_data;                                                        // cmd_mux_012:src_data -> Button_PIO_s1_burst_adapter:sink0_data
	wire          cmd_mux_012_src_ready;                                                       // Button_PIO_s1_burst_adapter:sink0_ready -> cmd_mux_012:src_ready
	wire   [13:0] cmd_mux_012_src_channel;                                                     // cmd_mux_012:src_channel -> Button_PIO_s1_burst_adapter:sink0_channel
	...
	wire          pacman_score_pio_s1_agent_rdata_fifo_out_valid;                              // PacMan_Score_PIO_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_011:in_0_valid
	wire   [33:0] pacman_score_pio_s1_agent_rdata_fifo_out_data;                               // PacMan_Score_PIO_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_011:in_0_data
	wire          pacman_score_pio_s1_agent_rdata_fifo_out_ready;                              // avalon_st_adapter_011:in_0_ready -> PacMan_Score_PIO_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_011_out_0_valid;                                           // avalon_st_adapter_011:out_0_valid -> PacMan_Score_PIO_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_011_out_0_data;                                            // avalon_st_adapter_011:out_0_data -> PacMan_Score_PIO_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                           // PacMan_Score_PIO_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                           // avalon_st_adapter_011:out_0_error -> PacMan_Score_PIO_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) pacman_score_pio_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                             //                      clk.clk
		.reset                  (PacMan_Score_PIO_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pacman_score_pio_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (pacman_score_pio_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (pacman_score_pio_s1_agent_m0_read),                  //                         .read
		.uav_write              (pacman_score_pio_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (pacman_score_pio_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (pacman_score_pio_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (pacman_score_pio_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (pacman_score_pio_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (pacman_score_pio_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (pacman_score_pio_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (pacman_score_pio_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (PacMan_Score_PIO_s1_address),                        //      avalon_anti_slave_0.address
		.av_write               (PacMan_Score_PIO_s1_write),                          //                         .write
		.av_readdata            (PacMan_Score_PIO_s1_readdata),                       //                         .readdata
		.av_writedata           (PacMan_Score_PIO_s1_writedata),                      //                         .writedata
		.av_chipselect          (PacMan_Score_PIO_s1_chipselect),                     //                         .chipselect
		.av_read                (),                                                   //              (terminated)
		.av_begintransfer       (),                                                   //              (terminated)
		.av_beginbursttransfer  (),                                                   //              (terminated)
		.av_burstcount          (),                                                   //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) pacman_score_pio_s1_agent (
		.clk                     (System_PLL_sys_clk_clk),                                  //             clk.clk
		.reset                   (PacMan_Score_PIO_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (pacman_score_pio_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (pacman_score_pio_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (pacman_score_pio_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (pacman_score_pio_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (pacman_score_pio_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (pacman_score_pio_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (pacman_score_pio_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (pacman_score_pio_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (pacman_score_pio_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (pacman_score_pio_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (pacman_score_pio_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (pacman_score_pio_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (pacman_score_pio_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (pacman_score_pio_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (pacman_score_pio_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (pacman_score_pio_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (pacman_score_pio_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (pacman_score_pio_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (pacman_score_pio_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (pacman_score_pio_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (pacman_score_pio_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (pacman_score_pio_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (pacman_score_pio_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (pacman_score_pio_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (pacman_score_pio_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (pacman_score_pio_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (pacman_score_pio_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (pacman_score_pio_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (pacman_score_pio_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (pacman_score_pio_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (pacman_score_pio_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (pacman_score_pio_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_011_out_0_ready),                       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_011_out_0_valid),                       //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_011_out_0_data),                        //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_011_out_0_error),                       //                .error
		.rdata_fifo_src_ready    (pacman_score_pio_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pacman_score_pio_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (pacman_score_pio_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                   //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                     //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pacman_score_pio_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                               //       clk.clk
		.reset             (PacMan_Score_PIO_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (pacman_score_pio_s1_agent_rf_source_data),             //        in.data
		.in_valid          (pacman_score_pio_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (pacman_score_pio_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (pacman_score_pio_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (pacman_score_pio_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (pacman_score_pio_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (pacman_score_pio_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (pacman_score_pio_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (pacman_score_pio_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (pacman_score_pio_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                // (terminated)
		.csr_read          (1'b0),                                                 // (terminated)
		.csr_write         (1'b0),                                                 // (terminated)
		.csr_readdata      (),                                                     // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pacman_score_pio_s1_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                             //       clk.clk
		.reset             (PacMan_Score_PIO_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pacman_score_pio_s1_agent_rdata_fifo_src_data),      //        in.data
		.in_valid          (pacman_score_pio_s1_agent_rdata_fifo_src_valid),     //          .valid
		.in_ready          (pacman_score_pio_s1_agent_rdata_fifo_src_ready),     //          .ready
		.out_data          (pacman_score_pio_s1_agent_rdata_fifo_out_data),      //       out.data
		.out_valid         (pacman_score_pio_s1_agent_rdata_fifo_out_valid),     //          .valid
		.out_ready         (pacman_score_pio_s1_agent_rdata_fifo_out_ready),     //          .ready
		.csr_address       (2'b00),                                              // (terminated)
		.csr_read          (1'b0),                                               // (terminated)
		.csr_write         (1'b0),                                               // (terminated)
		.csr_readdata      (),                                                   // (terminated)
	...
	Computer_System_mm_interconnect_2_router_002 router_013 (
		.sink_ready         (pacman_score_pio_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (pacman_score_pio_s1_agent_rp_valid),                 //          .valid
		.sink_data          (pacman_score_pio_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (pacman_score_pio_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (pacman_score_pio_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                             //       clk.clk
		.reset              (PacMan_Score_PIO_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) pacman_score_pio_s1_burst_adapter (
		.clk                   (System_PLL_sys_clk_clk),                                  //       cr0.clk
		.reset                 (PacMan_Score_PIO_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
		...
		.source0_valid         (pacman_score_pio_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (pacman_score_pio_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (pacman_score_pio_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (pacman_score_pio_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (pacman_score_pio_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (pacman_score_pio_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter_002 #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (PacMan_Score_PIO_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pacman_score_pio_s1_agent_rdata_fifo_out_data),      //     in_0.data
		.in_0_valid     (pacman_score_pio_s1_agent_rdata_fifo_out_valid),     //         .valid
		.in_0_ready     (pacman_score_pio_s1_agent_rdata_fifo_out_ready),     //         .ready
